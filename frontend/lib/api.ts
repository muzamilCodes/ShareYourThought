...
export const api = {
  ...
  getFollowers: (username: string) => apiFetch<{ followers: User[] }>(`/users/${username}/followers`),
  getFollowing: (username: string) => apiFetch<{ following: User[] }>(`/users/${username}/following`),
